...
function getQuizResultEvaluation(scores) {
    ...
    let evaluationDetails = `
        ...
        <div class="p-4 bg-white rounded-lg shadow-inner">
            ...
            ${physical < 9 ? `
            <p class="mb-1">🟢 <strong>Mức độ: Đang ở mức tốt</strong> (Điểm: ${25 - physical}/25)</p>
            ...
            ` : (physical < 18 ? `
            <p class="mb-1">🟡 <strong>Mức độ: Cần cải thiện</strong> (Điểm: ${25 - physical}/25)</p>
            ...
            ` : `
            <p class="mb-1">🔴 <strong>Mức độ: Đang có vấn đề</strong> (Điểm: ${25 - physical}/25)</p>
            ...
            ${mental < 9 ? `
            <p class="mb-1">🟢 <strong>Mức độ: Rất ổn định</strong> (Điểm: ${25 - mental}/25)</p>
            ...
            ` : (mental < 18 ? `
            <p class="mb-1">🟡 <strong>Mức độ: Cần được quan tâm</strong> (Điểm: ${25 - mental}/25)</p>
            ...
            ` : `
            <p class="mb-1">🔴 <strong>Mức độ: Đang bị ảnh hưởng nghiêm trọng</strong> (Điểm: ${25 - mental}/25)</p>
            ...
            ${concentration < 9 ? `
            <p class="mb-1">🟢 <strong>Mức độ: Rất tốt</strong> (Điểm: ${25 - concentration}/25)</p>
            ...
            ` : (concentration < 18 ? `
            <p class="mb-1">🟡 <strong>Mức độ: Cần rèn luyện thêm</strong> (Điểm: ${25 - concentration}/25)</p>
            ...
            ` : `
            <p class="mb-1">🔴 <strong>Mức độ: Đang rất thấp</strong> (Điểm: ${25 - concentration}/25)</p>
