...
let userData = {
    ...
    readingStreak: 0,
    exerciseStreak: 0,
    physical: 0 quizScores: {, mental: 0, concentration: 0 },
    quizHistory: [],
    lastLoginDate: null,
...
function getQuizResultEvaluation(scores) {
    ...
    let evaluationDetails = `
        ...
        <div class="p-4 bg-white rounded-lg shadow-inner">
            ...
            ${physical < 9 ? `
            <p class="mb-1">🟢 <strong>Mức độ: Đang ở mức tốt</strong> (Điểm Sức khỏe: ${25 - physical}/25)</p>
            ...
            ` : (physical < 18 ? `
            <p class="mb-1">🟡 <strong>Mức độ: Cần cải thiện</strong> (Điểm Sức khỏe: ${25 - physical}/25)</p>
            ...
            ` : `
            <p class="mb-1">🔴 <strong>Mức độ: Đang có vấn đề</strong> (Điểm Sức khỏe: ${25 - physical}/25)</p>
            ...
            ${mental < 9 ? `
            <p class="mb-1">🟢 <strong>Mức độ: Rất ổn định</strong> (Điểm Sức khỏe Tinh thần: ${25 - mental}/25)</p>
            ...
            ` : (mental < 18 ? `
            <p class="mb-1">🟡 <strong>Mức độ: Cần được quan tâm</strong> (Điểm Sức khỏe Tinh thần: ${25 - mental}/25)</p>
            ...
            ` : `
            <p class="mb-1">🔴 <strong>Mức độ: Đang bị ảnh hưởng nghiêm trọng</strong> (Điểm Sức khỏe Tinh thần: ${25 - mental}/25)</p>
            ...
            ${concentration < 9 ? `
            <p class="mb-1">🟢 <strong>Mức độ: Rất tốt</strong> (Điểm Sức khỏe Tập trung: ${25 - concentration}/25)</p>
            ...
            ` : (concentration < 18 ? `
            <p class="mb-1">🟡 <strong>Mức độ: Cần rèn luyện thêm</strong> (Điểm Sức khỏe Tập trung: ${25 - concentration}/25)</p>
            ...
            ` : `
            <p class="mb-1">🔴 <strong>Mức độ: Đang rất thấp</strong> (Điểm Sức khỏe Tập trung: ${25 - concentration}/25)</p>
            ...
            window.quizChart = new Chart(document.getElementById('quiz-chart').getContext('2d'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [25 - scores.physical, 25 - scores.mental, 25 - scores.concentration],
