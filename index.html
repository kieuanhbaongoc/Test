...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    <div id="app" class="bg-white rounded-3xl shadow-2xl p-6 md:p-10 w-full container">
        ...
        <div id="main-content" class="hidden">
            ...
            <div id="countdown-section" class="countdown-timer rounded-xl p-4 mb-6 shadow-md">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-blue-800">Đếm ngược đến reset hoạt động</p>
                        <p class="text-xs text-blue-600">Hoạt động lành mạnh sẽ được reset lúc 6:00 sáng</p>
                    </div>
                    <div class="text-2xl font-bold text-blue-800" id="countdown-timer">00:00:00</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-gray-50 rounded-xl p-6 shadow-md">
                    ...
                    <!-- THÊM MỚI: Nút lưu biểu đồ -->
                    <div class="text-center mt-4">
                        <button id="save-app-chart-btn" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-300">
                            <i class="fas fa-download mr-2"></i> Lưu Biểu Đồ Ứng Dụng
                        </button>
                    </div>
                </div>
                <!-- Bar Chart -->
                <div class="bg-gray-50 rounded-xl p-6 shadow-md">
                    ...
                    <!-- THÊM MỚI: Nút lưu biểu đồ -->
                    <div class="text-center mt-4">
                        <button id="save-weekly-chart-btn" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-300">
                            <i class="fas fa-download mr-2"></i> Lưu Biểu Đồ Tuần Này
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-xl p-6 mb-8 shadow-md">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-2xl font-semibold text-indigo-800">Lịch Sử Hoạt Động</h3>
                    <div class="flex space-x-2">
                        <button id="prev-day-btn" class="bg-gray-200 text-gray-700 px-3 py-1 rounded-lg hover:bg-gray-300 transition duration-300">
                            <i class="fas fa-chevron-left"></i>
                        </button>
                        <span id="history-date-display" class="font-medium text-gray-700"></span>
                        <button id="next-day-btn" class="bg-gray-200 text-gray-700 px-3 py-1 rounded-lg hover:bg-gray-300 transition duration-300">
                            <i class="fas fa-chevron-right"></i>
                        </button>
                    </div>
                </div>
                <div id="activity-history-container" class="activity-history">
            ...
            <div class="text-center mb-8">
                <button id="go-to-survey-btn" class="bg-indigo-600 text-white px-8 py-3 rounded-lg font-semibold shadow-lg hover:bg-indigo-700 transition duration-300">
                    <i class="fas fa-clipboard-list mr-2"></i> Khảo Sát Sức Khỏe
                </button>
            </div>
        ...
        <!-- Footer -->
        <div class="gradient-bg rounded-xl p-6 shadow-lg text-center">
            <p class="text-base font-bold text-white drop-shadow-lg">
                Trang web là sản phẩm được phát triển bởi <span class="font-extrabold">Hà Kiều Anh - Trần Lê Bảo Ngọc</span>
            </p>
        </div>
